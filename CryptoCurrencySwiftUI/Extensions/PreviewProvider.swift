...
class DeveloperPreview {
    ...
    let stat1 = Statistic(title: "Market Cap", value: "$12.68Bn", percentageChange: 25.34)
    let stat2 = Statistic(title: "Total Volume", value: "$1.68Tr")
    let stat3 = Statistic(title: "Portfolio Value", value: "$1.68Tr", percentageChange: -5.34)
